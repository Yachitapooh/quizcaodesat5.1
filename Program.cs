...
namespace quizcodesat5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("----------------");
            Console.WriteLine("Rose name:{0}", Plantname);
            Console.WriteLine("Rose name:{0} ", Plantdescription);

            Console.WriteLine("Sun Flower Information");
            Console.WriteLine("----------------");
            Console.WriteLine("Sun Flower:{0} ", Plantname2);
            Console.WriteLine("Sun Flower:{0} ", Plantdescription2);
        }
    }
    class Rose 
    {
